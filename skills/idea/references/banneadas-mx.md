...
Lista de patrones prohibidos en el plan generado, en la conversación durante la entrevista, y en los `prompt.md` por milestone. Esta lista se aplica además de las reglas globales de `skills/voz-gnb/`.
...
## Anti-patrones de planes

Frases que delatan plan genérica de ChatGPT — prohibidas:
...
Si vas a escribir algo en el plan y dudas si pasa el filtro:
