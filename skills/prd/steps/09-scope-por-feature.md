...
> Voy con mis defaults para las que quedan. Las marco con 🤖 en el PRD para que las revises antes de firmar. ¿Vamos?

Si dice sí: pre-llena las restantes y avanza a Fase 10. Marca cada una como `auto: true` para flag visual en el PRD final.
